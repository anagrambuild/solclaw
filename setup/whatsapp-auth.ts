...
<html><head><title>SolClaw - WhatsApp Auth</title>
...
<html><head><title>SolClaw - Connected!</title>
<style>
...
<script>localStorage.removeItem('solclaw_qr_start');</script>
</body></html>`;
